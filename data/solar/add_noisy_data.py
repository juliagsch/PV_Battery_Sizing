...
def get_solar_files():
    return [f"./data/solar/pvwatts_original/{f}" for f in os.listdir(f"./data/solar/pvwatts_original/") if f.endswith('.txt')]
...
def shift_time_series(time_series, shift_range=(0.9, 1.1)):
    """
